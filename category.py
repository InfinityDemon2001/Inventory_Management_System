...
class categoryClass:
    def __init__(self, root):
        ...
        self.categoryTable = ttk.Treeview(cat_frame, columns = ("cid", "name"), yscrollcommand = scroll_y.set, xscrollcommand = scroll_x.set)
        ...
        try:
            if self.var_name.get() == "":
                ...
                if row != None:
                    ...
                    con.commit()
                    messagebox.showerror("Success", "Category added succesfully", parent = self.root)
                    self.show()
